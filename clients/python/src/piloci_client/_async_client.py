"""Asynchronous AsyncPiloci client."""
...
class _AsyncMemoryNamespace:
    """Async namespace for memory operations: save, delete."""

    def __init__(self, client: "AsyncPiloci") -> None:
        self._c = client
    ...
    async def save(
        ...
        *,
        ...
        if tags is not None:
            body["tags"] = tags
        return MemoryResult.from_dict(await self._c._post("/api/v1/memory", body, project=project))
    ...
    async def list(
        ...
        *,
        ...
        """
        return await self._c.recall(query=query, limit=limit, tags=tags, project=project)


class _AsyncProjectsNamespace:
    """Async namespace for project operations: list, init."""

    def __init__(self, client: "AsyncPiloci") -> None:
        self._c = client

    async def list(self, refresh: bool = False) -> ProjectListResult:
        ...
        data = await self._c._get("/api/v1/projects", params=params)
    ...
    async def init(
        ...
        return InitResult.from_dict(await self._c._post("/api/v1/init", body))


class AsyncPiloci:
    """Asynchronous piLoci REST client.

    Identical public API to ``Piloci`` — every method is a coroutine.
    ...
    def __init__(
        ...
        self.memory = _AsyncMemoryNamespace(self)
    ...
    async def recall(
        ...
        *,
        ...
        if tags is not None:
            body["tags"] = tags
        return RecallResult.from_dict(await self._post("/api/v1/recall", body, project=project))
    ...
    async def whoami(self) -> WhoAmI:
        ...
        """
        return WhoAmI.from_dict(await self._get("/api/v1/whoami"))
    ...
    async def recommend(
        ...
        *,
        ...
        if domain is not None:
            body["domain"] = domain
        return RecommendResult.from_dict(
            await self._post("/api/v1/recommend", body, project=project)
        )
    ...
    async def contradict(
        ...
        *,
        ...
        return ContradictResult.from_dict(
            await self._post("/api/v1/contradict", body, project=project)
        )
    ...
    async def __aenter__(self) -> "AsyncPiloci":
        return self
